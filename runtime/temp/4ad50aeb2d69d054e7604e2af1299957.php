<?php /*a:2:{s:68:"/www/users/HA630745/WEB/yahoh/application/home/view/Index/index.html";i:1571665990;s:70:"/www/users/HA630745/WEB/yahoh/application/home/view/Index/jsindex.html";i:1571643239;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    //新闻资讯切换模块
$(function(){
    $("#knowledge-fit").click(function(){
        $("#knowledge-con").hide();
        $(this).addClass('active').siblings("button").removeClass("active");
        $("#knowledge-con1").show();
    });
    
    $("#knowledge-ativity").click(function(){
        $("#knowledge-con1").hide();
        $(this).addClass('active').siblings("button").removeClass("active");
        $("#knowledge-con").show();
    });
...
$(function(){
    ...
    $(window).scroll(function(event) {
        ...
        var slidebgheight=$("#slide-bg").height();
        var height=headerheight+slidebgheight;
        var menuheight=$(document).scrollTop();
        if (menuheight>height) {
            $(".btn-top").slideDown(500);
        }else{
            $(".btn-top").slideUp(500);
        };
    });
