<?php /*a:1:{s:74:"/www/users/HA630745/WEB/yahoh/application/home/view/Index/areadetails.html";i:1571669941;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="area-note" id="area-note">
        ...
        <div class="note-main">
            <div class="notecon">
                ...
                <div class="panel  panel-primary">
                    <div class="panel-heading">
                        <input type="checkbox">
                        <span><?php echo htmlentities(msubstr($v['create_time'],0,10)); ?></span>
                        <span>订单号：<?php echo htmlentities($v['order_id']); ?></span>
                        <span class="glyphicon glyphicon-trash fr"></span>
                    </div>
                    <table class="table">
                        <tr>
                            <th>场地名称</th>
                        ...
                        <?php foreach($ret as $k=>$val): if($val['order_id'] == $v['order_id']): ?>
                        <tr>
                            <td><?php echo htmlentities($val['areaname']); ?></td>
                            <td><?php echo htmlentities($val['areanum']); ?></td>
                            <td><?php echo htmlentities($val['date']); ?></td>
            ...
            <div class="pagedata"><?php echo $res; ?></div>
        </div>
    </div>
