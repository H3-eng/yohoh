<?php /*a:1:{s:71:"/www/users/HA630745/WEB/yahoh/application/home/view/Course/pcourse.html";i:1571646756;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="p-content">
            ...
            <div class="data clearfix">
                ...
                <div class="item-list col-md-4">
                    <div class="item-con">
                        <span>01</span>
                        <div class="incro">
                            <h5><?php echo htmlentities($v['course_name']); ?></h5>
                            <p class="coach-msg">指导教练：<?php echo htmlentities($v['coachname']); ?></p>
                            <div class="price">
                                <p class="fl"><em>￥</em><i><?php echo htmlentities($v['course_money']); ?></i></p>
                                <button class="top-btn fr" code="<?php echo htmlentities($v['id']); ?>" cpde="<?php echo htmlentities($v['course_name']); ?>">购买课程</button>
                            </div>
                        </div>
                    </div>
                    <div class="top-data col-md-12">
                        <div class="top-con">
                            <div class="top-title"><?php echo htmlentities($v['role']); ?></div>
                            <p class="decribe"><?php echo htmlentities($v['described']); ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
        ...
        <div class="buybox" id="buybox">
            <div class="buy-con">
                ...
                <form class="formlist" id="formlist">
                    <input type="hidden" name="course_name" id="course_name">
                    <input type="hidden" name="course_id" id="course_id">
                    <input type="hidden" name="member_id" value="<?php echo htmlentities(app('request')->session('member.id')); ?>">
                    ...
                    <div class="button-group">
                       ...
                       <button type="button" class="btn btn-success send">提交</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    $(".top-btn").click(function () {
        ...
        $(".send").off().click(function(){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo url('home/Course/padd'); ?>",
                dataType:"json",
                data:data,
