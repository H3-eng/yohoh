<?php /*a:1:{s:77:"/www/users/HA630745/WEB/yahoh/application/admin/view/Newsform/knowledgeu.html";i:1571663982;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>健身知识修改页面</title>
	<!--H+框架样式-->
...
<div class="ibox-content">
	<a href="<?php echo url('admin/newsform/knowledge'); ?>" class="btn btn-danger">返回上一页</a>
	<form class="form-horizontal" action="<?php echo url('admin/newsform/knowledgeUpdatepro'); ?>" method="post" accept-charset="utf-8" id="formlist">
		<input type="hidden" name="id" value="<?php echo htmlentities($data['id']); ?>}">
		<input type="hidden" name="updatename" value="<?php echo htmlentities(app('request')->session('admin.adminname')); ?>">
		<div class="form-group">
			<label class="col-sm-3 control-label">文章标题</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" name="title" id="title" value="<?php echo htmlentities($data['title']); ?>" autofocus>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control"  name="subtitle" value="<?php echo htmlentities($data['subtitle']); ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label">关键词</label>
			<div class="col-sm-6">
				<input type="text" class="form-control"  name="keyword" value="<?php echo htmlentities($data['keyword']); ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label">文章内容</label>
			<div class="col-sm-6">
				<textarea name="content" id="editor"  type="text/plain" class="knowledge-content"><?php echo htmlentities($data['content']); ?></textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-5 uploadbox">
				<div id="box" class="photobox fl">
					<img src="<?php echo htmlentities($data['pic_name']); ?>" id="avatar">
				</div>
...
var uploader = WebUploader.create({
	...
	server: "<?php echo url('admin/Newsform/picpro'); ?>",
	pick: '#Picker',
	resize:false,
	fileVal:'picname',
	formData:{
