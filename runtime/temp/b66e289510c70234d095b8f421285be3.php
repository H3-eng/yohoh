<?php /*a:1:{s:76:"/www/users/HA630745/WEB/yahoh/application/admin/view/Newsform/activityu.html";i:1571667277;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>会员活动修改页面</title>
	<!--H+框架样式-->
...
<div class="ibox-content">
	...
	<form class="form-horizontal" action="<?php echo url('admin/Newsform/activityUpdatepro'); ?>" method="post" accept-charset="utf-8" id="formlist">
...
var uploader = WebUploader.create({
	...
	server: "<?php echo url('admin/Newsform/appicpro'); ?>",
	pick: '#Picker',
	resize:false,
	fileVal:'picname',
	formData:{
