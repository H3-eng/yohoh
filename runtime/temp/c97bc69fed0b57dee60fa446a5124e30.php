<?php /*a:3:{s:78:"/www/users/HA630745/WEB/yahoh/application/admin/view/Adminerform/roleform.html";i:1571624486;s:80:"/www/users/HA630745/WEB/yahoh/application/admin/view/Adminerform/jsroleform.html";i:1571624476;s:76:"/www/users/HA630745/WEB/yahoh/application/admin/view/Common/jsformcheck.html";i:1571579985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="deletegroup fl">
                            ...
                            <button type="button" class="btn btn-success" id="add">添加角色</button>
                        </div>
                        <div class="searchgroup fr col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="请输入角色名称" class="input-sm form-control" id="search" autocomplete="off">
    ...
    <div class="addbox">
        ...
        <form accept-charset="utf-8" id="formlist">
            ...
            <div class="form-group clearfix">
                ...
                <label for="rolename" class="error"></label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="rolename" id="rolename">
                </div>
            </div>
            <div class="form-group clearfix">
                <label class="col-sm-4 control-label">角色权限</label>
                <div class="col-sm-6">
                    <select name="powerid" id="powerid" class="form-control">
                        <?php foreach($data as $k=>$v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" class="option"><?php echo htmlentities($v['powername']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
...
<script>
    ...
    function getData(page){
        $.ajax({
            type:'get',
            url:"<?php echo url('admin/Adminerform/roleformshow'); ?>",
            data:{page:page},
            dataType:"json",
    ...
    $("#add").off().click(function () {
        ...
        $(".addbtn").off().click(function(){
            if(validator("#formlist").form()) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo url('admin/Adminerform/roleadd'); ?>",
                    dataType: "json",
                    data: data,
                    success: function (data) {
                        if (data.code == 1) {
    ...
    function updateshow(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Adminerform/roleupdateshow'); ?>",
            dataType:"json",
            data:{id:id},
            success:function(data){
                if (data) {
    ...
    function update(){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Adminerform/roleupdate'); ?>",
            dataType:"json",
            data:data,
            success:function(data){
                if (data.code==1) {
    ...
    function del(id){
        ...
        $("#sure").off().click(function () {
            $("#isdel").hide();
            $.ajax({
                url: "<?php echo url('admin/Adminerform/roledelete'); ?>",
                type: 'post',
                dataType: 'json',
                data: {id:id},
                success:function(data){
    ...
    $("#deletesome").click(function(){
        ...
        $("#sure").off().click(function () {
            ...
            $.ajax({
                url: "<?php echo url('admin/Adminerform/roledeletesome'); ?>",
                type: 'post',
                dataType: 'json',
                data: {ids:arr},
                success:function(data){
    ...
    $("#search").off().keyup(function () {
        ...
        $.ajax({
            url: "<?php echo url('admin/Adminerform/rolesearch'); ?>",
            type: 'post',
            dataType: 'json',
            data: {data:data},
            success:function(data){
