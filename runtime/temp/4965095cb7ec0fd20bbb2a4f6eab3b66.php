<?php /*a:3:{s:80:"/www/users/HA630745/WEB/yahoh/application/admin/view/Courseform/pcourseform.html";i:1571626638;s:82:"/www/users/HA630745/WEB/yahoh/application/admin/view/Courseform/jspcourseform.html";i:1571626560;s:76:"/www/users/HA630745/WEB/yahoh/application/admin/view/Common/jsformcheck.html";i:1571579985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function getData(page){
        $.ajax({
            type:'get',
            url:"<?php echo url('admin/Courseform/pcourseformshow'); ?>",
            data:{page:page},
            dataType:"json",
            success:function(data){
                if(data){
                    ...
                    for(var i=1;i<data.length;i++){
                        ...
                        str+="<td>"+data[i].course_money+"</td>";
                        str+="<td>"+data[i].course_num+"</td>";
                        str+="<td>"+data[i].member_num+"</td>";
    ...
    $("#add").off().click(function () {
        ...
        $(".addbtn").off().click(function(){
            if(validator("#formlist").form()){
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo url('admin/Courseform/padd'); ?>",
                    dataType: "json",
                    data:data,
                    success:function(data){
                        if (data.code==1) {
    ...
    function updateshow(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Courseform/pupdateshow'); ?>",
            dataType:"json",
            data:{id:id},
            success:function(data){
                if (data) {
    ...
    function update(){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Courseform/pupdate'); ?>",
            dataType:"json",
            data:data,
            success:function(data){
                if (data.code==1) {
    ...
    function del(id){
        ...
        $("#sure").off().click(function () {
            $("#isdel").hide();
            $.ajax({
                url: "<?php echo url('admin/Courseform/pdelete'); ?>",
                type: 'post',
                dataType: 'json',
                data: {id:id},
                success:function(data){
    ...
    $("#search").keyup(function () {
        ...
        $.ajax({
            url: "<?php echo url('admin/Courseform/psearch'); ?>",
            type: 'post',
            dataType: 'json',
            data: {data:data},
            success:function(data){
