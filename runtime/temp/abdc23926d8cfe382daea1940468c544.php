<?php /*a:1:{s:71:"/www/users/HA630745/WEB/yahoh/application/home/view/Common/article.html";i:1571658782;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>文章页面</title>
    ...
    <body>
        ...
        <div class="article-nav inner clearfix">
            <ul>
                <li><i class="glyphicon glyphicon-home"></i></li>
                <li><a href="<?php echo url('home/Index/index'); ?>">网站首页</a></li>
                <li>/</li>
                <?php if($type == 'activity'): ?>
                <li><a href="<?php echo url('home/Activity/customers'); ?>">会员专区</a></li>
                <?php else: ?>
                <li><a href="<?php echo url('home/Knowledge/knowledge'); ?>">健身知识</a></li>
                <?php endif; ?>
                <li>/</li>
        ...
        <div class="article">
            <div class="article-content inner">
                <h1><?php echo htmlentities($data[1]['title']); ?></h1>
                <p class="article-texttime">
                    <span><?php echo htmlentities($data[1]['create_time']); ?></span>
                    <span class="glyphicon glyphicon-eye-open"></span>
                    <span><?php echo htmlentities($data[1]['hits']); ?></span>
                </p>
                ...
                <div class="article-page clearfix">
                    <?php if($type == 'activity'): ?>
                    <div class="left-page fl">
                        <a href="<?php echo url('home/activity/article',['id'=>$data[0]['id']]); ?>">
                            <?php if($data[0]['title']): ?>
                            <span>上一页:<?php echo htmlentities($data[0]['title']); ?></span>
                            <?php else: ?>
                            <span>上一页:没有了</span>
                            <?php endif; ?>
                        </a>
                    ...
                    <div class="right-page fr">
                        <a href="<?php echo url('home/activity/article',['id'=>$data[2]['id']]); ?>">
                            <?php if($data[2]['title']): ?>
                            <span>下一页:<?php echo htmlentities($data[2]['title']); ?></span>
                            <?php else: ?>
                            <span>下一页:没有了</span>
                            <?php endif; ?>
                        </a>
                    ...
                    <?php else: ?>
                    <div class="left-page fl">
                        <a href="<?php echo url('home/knowledge/article',['id'=>$data[0]['id']]); ?>">
                            <?php if($data[0]['title']): ?>
                            <span>上一页:<?php echo htmlentities($data[0]['title']); ?></span>
                            <?php else: ?>
                            <span>上一页:没有了</span>
                    ...
                    <div class="right-page fr">
                        <a href="<?php echo url('home/knowledge/article',['id'=>$data[2]['id']]); ?>">
                            <?php if($data[2]['title']): ?>
                            <span>下一页:<?php echo htmlentities($data[2]['title']); ?></span>
                            <?php else: ?>
                            <span>下一页:没有了</span>
