<?php /*a:3:{s:75:"/www/users/HA630745/WEB/yahoh/application/admin/view/Areaform/areaform.html";i:1571624617;s:77:"/www/users/HA630745/WEB/yahoh/application/admin/view/Areaform/jsareaform.html";i:1571624612;s:76:"/www/users/HA630745/WEB/yahoh/application/admin/view/Common/jsformcheck.html";i:1571579985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="addbox">
        ...
        <form accept-charset="utf-8" id="formlist">
            ...
            <div class="form-group clearfix">
                <label class="col-sm-4 control-label">场地编号</label>
                <div class="col-sm-6">
...
<script>
    ...
    function getData(page){
        $.ajax({
            type:'get',
            url:"<?php echo url('admin/Areaform/areaformshow'); ?>",
            data:{page:page},
            dataType:"json",
    ...
    $("#add").off().click(function () {
        ...
        $(".addbtn").off().click(function(){
            if(validator("#formlist").form()){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php echo url('admin/Areaform/add'); ?>",
                    dataType:"json",
                    data:data,
                    success:function(data){
                        if (data.code==1) {
    ...
    function updateshow(id){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Areaform/updateshow'); ?>",
            dataType:"json",
            data:{id:id},
            success:function(data){
                if (data) {
    ...
    function update(){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('admin/Areaform/update'); ?>",
            dataType:"json",
            data:data,
            success:function(data){
                if (data.code==1) {
    ...
    function del(id){
        ...
        $("#sure").off().click(function () {
            $("#isdel").hide();
            $.ajax({
                url: "<?php echo url('admin/Areaform/delete'); ?>",
                type: 'post',
                dataType: 'json',
                data: {id:id},
                success:function(data){
    ...
    $("#deletesome").off().click(function(){
        ...
        $("#sure").off().click(function () {
            ...
            $.ajax({
                url: "<?php echo url('admin/Areaform/deletesome'); ?>",
                type: 'post',
                dataType: 'json',
                data: {ids:arr},
                success:function(data){
    ...
    $("#search").off().keyup(function () {
        ...
        $.ajax({
            url: "<?php echo url('admin/Areaform/search'); ?>",
            type: 'post',
            dataType: 'json',
            data: {data:data},
            success:function(data){
