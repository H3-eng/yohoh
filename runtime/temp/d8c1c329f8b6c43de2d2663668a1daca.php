<?php /*a:1:{s:70:"/www/users/HA630745/WEB/yahoh/application/home/view/Index/logsmsg.html";i:1571670853;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="logs">
        <div class="l_content inner clearfix">
            <div class="con-all clearfix">
                <div class="l_aside col-md-4">
                    <div class="aside-list">登录记录</div>
                </div>
                <div class="logdetails col-md-8">
                    ...
                    <div class="pagelist"><?php echo $res; ?></div>
                </div>
            </div>
